...
fun Screen2(
    ...
    Surface(
        ...
        TutorialImage(
            ...
            message2 = "Jetpack Compose is a modern toolkit for building native Android UI." +
                    " Compose simplifies and accelerates UI development on Android with less code," +
                    " powerful tools, and intuitive Kotlin APIs.",
            message3 = "In this tutorial, you build a simple UI component with declarative functions." +
...
@Composable
fun TutorialText(message1: String, message2: String, message3: String, modifier: Modifier) {
...
@Composable
fun TutorialImage(message1: String, message2: String, message3: String, modifier: Modifier) {
    val paint = painterResource(R.drawable.bg_compose_background)
    Box(modifier) {
        Image(
            painter = paint,
